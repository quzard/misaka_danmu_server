...
async def create_scheduled_task(
    ...
    try:
        new_task = await scheduler.add_task(task_data.name, task_data.jobType, task_data.cronExpression, task_data.isEnabled, task_data.forceScrape)
...
async def update_scheduled_task(
    ...
    updated_task = await scheduler.update_task(taskId, task_data.name, task_data.cronExpression, task_data.isEnabled, task_data.forceScrape)
    if not updated_task:
