...
# Explicitly include all metadata source APIs under the /ui prefix for clarity and robustness.
api_router.include_router(bangumi_router, prefix="/ui/bangumi", tags=["Bangumi"], include_in_schema=False)
api_router.include_router(tmdb_router, prefix="/ui/tmdb", tags=["TMDB"], include_in_schema=False)
api_router.include_router(douban_router, prefix="/ui/douban", tags=["Douban"], include_in_schema=False)
api_router.include_router(imdb_router, prefix="/ui/imdb", tags=["IMDb"], include_in_schema=False)
api_router.include_router(tvdb_router, prefix="/ui/tvdb", tags=["TVDB"], include_in_schema=False)
