...
# The ui_router is the main entry point for all UI-related APIs.
# It dynamically includes the individual metadata source routers (bangumi, tmdb, etc.)
# so we don't need to include them separately here.
